...
const SEGMENTS = [
  {
    id: 0,
    title: 'Yield Premium',
    body: 'STR units net 8 – 11 % vs 4 – 6 % on 12-month lets (AirDNA 2024).',
    icon: TrendingUp,
    color: 'fill-primary',
    start:   0,
    end:    90,
  ...
  {
    id: 1,
    title: 'Demand Beyond CBD',
    body: '+42 % YoY search surge in periphery districts.',
    icon: MapPin,
  ...
  },
  {
    id: 2,
    title: 'Scarce Stock',
    body: 'STR = 1.6 % of total housing vs 3.4 % in peer hubs.',
    icon: Home,
  ...
  {
    id: 3,
    title: 'ADR Resilience',
    body: 'ADR grew +6.1 % CAGR (2019-23).',
    icon: Activity,
