...
const studies = [
  {
    ...
    boughtFor: '€ 420 000',
    sqm: 290,
    longRent: '€ 1 950 / месец',
    shortRent: '€ 2 535 / месец',
    credit: '≈ 50 % по-нисък',
    yield: '8.5 %',
    holdTime: '3.5 години',
    appreciation: '+6 % годишно',
  },
  {
    id: 2,
    ...
    boughtFor: '€ 210 000',
    sqm: 160,
    longRent: '€ 1 100 / месец',
    shortRent: '€ 1 435 / месец',
    credit: '-48 %',
    yield: '9.2 %',
    holdTime: '2 години',
    appreciation: '+5 % годишно',
  },
  {
    id: 3,
    ...
    boughtFor: '€ 530 000',
    sqm: 310,
    longRent: '€ 2 350 / месец',
    shortRent: '€ 3 055 / месец',
    credit: '-52 %',
    yield: '7.8 %',
    holdTime: '4 години',
