    ...
    <div className="container grid md:grid-cols-2 gap-12 items-center">
      ...
      <div className="relative">
        ...
        >
          ...
          <p className="text-xs opacity-80">678 guest reviews</p>
        </motion.div>
      </div>
      ...
      >
        <h2 className="text-3xl md:text-4xl font-extrabold text-primary mb-4">
          Earn more from every night — we do the work
        </h2>

        <p className="text-gray-800 mb-4 leading-relaxed">
          Nomadica turns your apartment into a hotel-grade listing on Airbnb, Booking.com
          and 18 other platforms. Our pricing engine updates rates daily; our guest team
          answers in minutes; our cleaners leave the place spotless after every stay.
        </p>

        <p className="text-gray-800 mb-8 leading-relaxed">
          You keep full ownership and flexibility. Block dates for personal use,
          see revenue in real time, and receive one clear payout each month —
          <strong> typically 40–60 % higher</strong> than a traditional lease.
        </p>
